...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".edit").on('click', function() {
		var $this = $(this);
			family_id = $this.attr("_id");
			is_edit = false;

		var parentsList = $this.parents('tr');
		var relationship = $this.attr('relationship_id');
		var name = parentsList.find('.name').text();
		var phone = parentsList.find('.phone').text();
		var birth_date = parentsList.find('.birth_date').text();
	...
	$("#addSubmit").on('click', function() {
		...
		if( is_edit ){
			ajaxFun(dataObj,$this,'/ehradmin/archive/add-family');
		}else{
			dataObj.family_id = family_id;
			ajaxFun(dataObj,$this,'/ehradmin/archive/update-family');
		}
	});
