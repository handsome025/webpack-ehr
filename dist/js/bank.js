...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".edit").on('click', function() {
		var $this = $(this);
			bank_id = $this.attr("_id");
			is_edit = false;
		var bank_code = $this.attr('bank_code');

		var parentsList = $(this).parents('tr');
		var bank_address = parentsList.find('.bank_address').text();
		var bank_account = parentsList.find('.bank_account').text();
	...
	$("#addSubmit").on('click', function() {
		...
		if( is_edit ){
			ajaxFun(dataObj,$this,'/ehradmin/archive/banka');
		}else{
			dataObj.bank_id = bank_id;
			ajaxFun(dataObj,$this,'/ehradmin/archive/banke');
		}
	});
