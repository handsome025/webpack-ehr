...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".edit").on('click', function() {
		var $this = $(this);
			educ_id = $this.attr("_id");
			is_edit = false;
		var degree = $this.attr('degree');

		var parentsList = $(this).parents('tr');
		var school = parentsList.find('.school').text();
		var start_date = parentsList.find('.start_date').text();
		var end_date = parentsList.find('.end_date').text();
		var major = parentsList.find('.major').text();
		var cer_name = parentsList.find('.cer_name').text();
		var obtain_date = parentsList.find('.obtain_date').text();
		...
		$('#major').val(major);
		$('#cer_name').val(cer_name);
		$('#obtain_date').val(obtain_date);
	...
	$("#addSubmit").on('click', function() {
		...
		if( is_edit ){
			ajaxFun(dataObj,$this,'/ehradmin/archive/educationa');
		}else{
			dataObj.educ_id = educ_id;
			ajaxFun(dataObj,$this,'/ehradmin/archive/educatione');
		}
	});
