...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".edit").on('click', function() {
		...
		var company = parentsList.find('.company').text();
		var position = parentsList.find('.position').text();
	...
	$("#addSubmit").on('click', function() {
		...
		if( is_edit ){
			ajaxFun(dataObj,$this,'/ehradmin/archive/add-work-ex');
		}else{
			dataObj.ex_id = ex_id;
			ajaxFun(dataObj,$this,'/ehradmin/archive/update-work-ex');
		}
	});
