...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".edit").on('click', function() {
		var $this = $(this);
			ctct_id = $this.attr("_id");
			is_edit = false;
		var type = $this.attr('type');
		var probation_period = $this.attr('probation_period');
		var contract_vested = $this.attr('contract_vested');
		...
		var obtainment_date = parentsList.find('.obtainment_date').text();
		
		$('#type').val(type);
		$('#probation_period').val(probation_period);
		$('#contract_vested').val(contract_vested);
		$('#start_date').val(start_date);
		$('#end_date').val(end_date);
		$('#obtainment_date').val(obtainment_date);
	...
	$("#addSubmit").on('click', function() {
		...
		var obtainment_date = $("#obtainment_date").val();
		var contract_vested = $("#contract_vested").val();
		...
		var dataObj = {
			...
			contract_vested:contract_vested
		}
		if( is_edit ){
			ajaxFun(dataObj,$this,'/ehradmin/archive/contracta');
		}else{
			dataObj.ctct_id = ctct_id;
			ajaxFun(dataObj,$this,'/ehradmin/archive/contracte');
		}
	});
